...
{
    uint8 staticBits = (switch_1_DR & (uint8)(~switch_1_MASK));
    switch_1_DR = staticBits | ((uint8)(value << switch_1_SHIFT) & switch_1_MASK);
}
...
{
	CyPins_SetPinDriveMode(switch_1_0, mode);
}
...
{
    return (switch_1_PS & switch_1_MASK) >> switch_1_SHIFT;
}
...
{
    return (switch_1_DR & switch_1_MASK) >> switch_1_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(switch_1_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & switch_1_0_INTR) != 0u) 
		{ 
			 switch_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (switch_1_INTSTAT & switch_1_MASK) >> switch_1_SHIFT;
    }
