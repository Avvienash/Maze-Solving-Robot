 ...
 **************************************/
#define Counter_CAPTURE_MODE_CONF       2u
...
#else
#define Counter_INIT_COMPARE_VALUE      32767u
#define Counter_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
...
#define Counter_DEFAULT_COMPARE_MODE    4u

#if( 0 != Counter_CAPTURE_MODE_CONF)
    #define Counter_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)2u << Counter_CTRL_CAPMODE0_SHIFT))
#else    
    #define Counter_DEFAULT_CAPTURE_MODE    (2u )
